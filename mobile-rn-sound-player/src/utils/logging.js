...
export const error = logff.bind(logff, { color: 'red', space: '' });
export const warn = logff.bind(logff, { color: 'orange', space: ''});
export const deb = logff.bind(logff, { color: 'green', space: '   '});
